class DarkModeHandler {
  ...
  constructor() {
    this.is_dark_mode =
      localStorage.getItem(this.DARK_MODE_LOCAL_STORAGE_ITEM_NAME) == "true";
  ...
  toggleDarkMode() {
    ...
    if (typeof d3 != "undefined") {
      ...
      d3.selectAll(".darkable").style("stroke", getComputedStyle(document.body).color);
    }
  ...
  toggleDarkModeForSession() {
    ...
    localStorage.setItem(
      this.DARK_MODE_LOCAL_STORAGE_ITEM_NAME,
      this.is_dark_mode
    );
    // Se
    this.toggleDarkMode();
