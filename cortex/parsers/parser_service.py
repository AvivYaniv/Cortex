...
class ParserContext:
    def __init__(self, user_id, snapshot_uuid, parser_type):
...
class ParserService:
    ...
    def _set_context(self, raw_snapshot_message):
        return ParserContext(raw_snapshot_message.user_id, raw_snapshot_message.snapshot_uuid, self.parser_type)    
