...
Cortex is an *ultra [**flexibale**](https://github.com/AvivYaniv/Cortex/blob/master/README.md#5-flexability-and-solidness) and **durable*** [brain-comuter-interface](https://en.wikipedia.org/wiki/Brain%E2%80%93computer_interface) large-scale project, which enabels to upload and view users telemetry data. 
